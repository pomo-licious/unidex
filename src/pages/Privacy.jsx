  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-slate-400 mb-12">Effective date: June 9, 2026</p>
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-slate-400 text-sm mt-4">We do not collect financial information, government IDs, biometric data, or data from minors.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-white mt-6">Contact: <a href="mailto:privacy@unidex.co.in" className="text-[#c9a84c] hover:underline">privacy@unidex.co.in</a> — respond within 72 hours, action within 30 days</p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-400 text-sm mt-4">When you delete your account, all PII is permanently deleted within 30 days.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-white">We use only essential session cookies. No advertising or tracking cookies.</p>
          </section>

          {/* Section 8 */}
          <section>
            <h2 className="text-3xl font-bold text-[#c9a84c] mb-6">Section 8 — Contact</h2>
            <div className="bg-slate-800 rounded-lg p-6 space-y-2 text-white">
